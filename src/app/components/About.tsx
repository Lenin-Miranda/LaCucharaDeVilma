...
const photos = [
  { src: "/images/enchiladas.jpeg", alt: "Enchiladas nicaragüenses" },
    ...
    <section className="w-full py-20 md:py-28 bg-nica-blue-soft dark:bg-nica-blue-dark overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
        ...
        <div className="flex-1 max-w-xl w-full">
          ...
          >
            Somos un restaurante en casa dedicado a traer el auténtico sabor de Nicaragua a Las Vegas. Nuestra misión es honrar y recordar nuestra patria a través del sazón inconfundible de la comida nica, preparada con el mismo cariño y dedicación de nuestras abuelas.
          </p>
          <p
            data-aos="fade-up"
            data-aos-delay="160"
          ...
          >
            Con más de 3 años compartiendo nuestra mesa en Las Vegas y más de 8 años de experiencia en la cocina, cada platillo es una celebración de nuestras raíces. Somos más que un restaurante: somos una familia.
          </p>
          ...
          >
            <div className="bg-nica-blue dark:bg-nica-blue/50 rounded-2xl p-5 text-center shadow-lg shadow-nica-blue/20">
              ...
              <p className="text-xs text-white/75 uppercase tracking-wide">Años de experiencia</p>
            </div>
            <div className="bg-nica-gold dark:bg-nica-gold/40 rounded-2xl p-5 text-center shadow-lg shadow-nica-gold/20">
              ...
              <p className="text-xs text-white/80 uppercase tracking-wide">Años en Las Vegas</p>
            </div>
          </div>
        </div>
